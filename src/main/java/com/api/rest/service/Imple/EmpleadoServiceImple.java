package com.api.rest.service.Imple;
...
@Service
public class EmpleadoServiceImple implements EmpleadoService {
    ...
    public Empleado saveEmpleado(Empleado empleado) {
        ...
        if (empleadoGuardado.isPresent()){
            throw  new ResourceNotFoundException("El empleado con ese email ya exite : " + empleado.getEmail());
        }
